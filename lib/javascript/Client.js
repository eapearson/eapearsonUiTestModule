...
function eapearsonUiTestModule(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_time_test = function (delay, _callback, _errorCallback) {
        if (typeof delay === 'function')
            throw 'Argument delay can not be a function';
        ...
        return json_call_ajax(_url, "eapearsonUiTestModule.run_time_test",
            [delay], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "eapearsonUiTestModule.status",
