package eapearsonuitestmodule.test;
...
import eapearsonuitestmodule.EapearsonUiTestModuleServer;
...
public class EapearsonUiTestModuleServerTest {
    private static AuthToken token = null;
    private static Map<String, String> config = null;
    private static WorkspaceClient wsClient = null;
    private static String wsName = null;
    private static EapearsonUiTestModuleServer impl = null;
    ...
    public static void init() throws Exception {
        ...
        config = ini.get("eapearsonUiTestModule");
        ...
        impl = new EapearsonUiTestModuleServer();
    }
    
    private static String getWsName() throws Exception {
        if (wsName == null) {
            long suffix = System.currentTimeMillis();
            wsName = "test_EapearsonUiTestModule_" + suffix;
    ...
    private static RpcContext getContext() {
        return new RpcContext().withProvenance(Arrays.asList(new ProvenanceAction()
            .withService("eapearsonUiTestModule").withMethod("please_never_use_it_in_production")
